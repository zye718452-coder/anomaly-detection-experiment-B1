...
def adjust_learning_rate(optimizer, epoch, lr_):
    # decay every 5 epochs instead of every epoch
...
class EarlyStopping:
    ...
    def __call__(self, val_loss, val_loss2, model, path):
        # smaller validation loss is better
...
class Solver(object):
    ...
    def vali(self, vali_loader):
        ...
        for i, (input_data, _) in enumerate(vali_loader):
            ...
            # GNN version returns:
            # output, series, prior, sigmas, aux_info
    ...
    def train(self):
        ...
        # patience increased from 3 to 5
        ...
        for epoch in range(self.num_epochs):
            ...
            # print sample-dependent alpha stats from cached last_alpha
            model_ref = self.model.module if hasattr(self.model, 'module') else self.model
            if hasattr(model_ref, 'last_alpha') and model_ref.last_alpha is not None:
                alpha = model_ref.last_alpha.detach().cpu().numpy()   # [B, C]
                print(
