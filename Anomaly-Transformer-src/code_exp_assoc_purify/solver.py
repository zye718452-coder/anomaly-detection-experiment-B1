...
class Solver(object):
    ...
    def build_model(self):
        self.model = AnomalyTransformer(
            ...
            evidence_bias=bool(self.evidence_bias),
            evidence_lambda=self.evidence_lambda,
            evidence_ma_kernel=self.evidence_ma_kernel,
            evidence_local_kernel=self.evidence_local_kernel,
            evidence_hidden_dim=self.evidence_hidden_dim,
            evidence_share_across_heads=bool(self.evidence_share_across_heads)
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for i, (input_data, labels) in enumerate(self.train_loader):
                ...
                # minimax training as in original AT
    ...
    def test(self):
        ...
        # point-adjustment as in common AT evaluation
        anomaly_state = False
